...
#endif
		Field_CompleteFilename( "demos", demoExt, qtrue, FS_MATCH_EXTERN | FS_MATCH_STICK | FS_MATCH_SUBDIRS );
	}
}
...
#ifdef USE_URT_DEMO
        	Field_CompleteFilename( "demos", ".urtdemo", qfalse, FS_MATCH_ANY | FS_MATCH_STICK | FS_MATCH_SUBDIRS );
#else
		Field_CompleteFilename( "demos", ".dm_??", qfalse, FS_MATCH_ANY | FS_MATCH_STICK | FS_MATCH_SUBDIRS );
#endif
...
//	cl_allowDownload = Cvar_Get( "cl_allowDownload", "1", CVAR_ARCHIVE );
	cl_allowDownload = Cvar_Get( "cl_allowDownload", "1", CVAR_ROM );
#ifdef USE_CURL
